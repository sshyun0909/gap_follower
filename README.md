...
### Overview
ReactiveGapFollow is a simple ROS2-based autonomous driving algorithm that uses LiDAR data to detect and follow the largest gap in the environment. This approach is useful in scenarios where obstacles need to be avoided dynamically while maintaining a forward trajectory.
